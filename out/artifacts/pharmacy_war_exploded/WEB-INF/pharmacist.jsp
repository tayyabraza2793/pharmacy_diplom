...
<c:if test="${currentUser != null}">
    <div>
        <form class="form__horizontal" method="post" autocomplete="off" action="pharmacistDataServlet">
                        ...
                        <span class="td">
                            <c:choose>
                                ...
                                <c:when test="${servletType.equals('medicine')}">
                                    <button class="td_button" type="submit" value="edit"
                                            name="action">Редактировать</button>
                                </c:when>
<%--                                <c:when test="${servletType.equals('order')}">--%>
<%--                                    <c:if test="${!item.status.equals('Отменен')}">--%>
<%--                                        <button class="td_button" disabled>Оплатить</button>--%>
<%--                                    </c:if>--%>
<%--                                </c:when>--%>
                            </c:choose>
                        </span>
            ...
            <p></p>
            <c:if test="${servletType.equals('medicine')}">
