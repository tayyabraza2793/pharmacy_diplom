...
public class PharmacistDataServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            switch (dataType) {
                case "order": {
                    req.setAttribute("returnedData", new OrderServiceImpl().getOrders());
                ...
                case "company": {
                    req.setAttribute("returnedData", new CompanyServiceImpl().getCompanies());
                    ArrayList<String> fields = new ArrayList<String>
                            (Arrays.asList("Ид", "Имя", "Описание", "Эл.почта", "Адрес", "Телефон"));
                    req.setAttribute("dataFields", fields);
            ...
            RequestDispatcher requestDispatcher = context.getRequestDispatcher("/pharmacistPage");
